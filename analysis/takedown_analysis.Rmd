...
content_restrictions_df |> dplyr::select(-count) -> content_restrictions_df
...
```{r}
names(combined_df)
combined_df |> left_join(content_restrictions_df, by=c('country_code' = 'country_code', 'Date' = 'Date'))
